...
public class MoveToLeftNode extends CommandBase {
  ...
  public MoveToLeftNode(SwerveSubsystem swerveSubsystem, LimeLight visionSubsystem) {
  ...
  public void execute() {
    ...
    if(visionSubsystem.getTID() == 8.0 || visionSubsystem.getTID() == 3.0){
