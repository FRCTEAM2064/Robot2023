...
public class MoveToRightNode extends CommandBase {
  ...
  public MoveToRightNode(SwerveSubsystem swerveSubsystem, LimeLight visionSubsystem) {
  ...
  public void execute() {
    ...
    if(visionSubsystem.getTID() == 1.0 || visionSubsystem.getTID() == 6.0){
        xController.setSetpoint(-38.8);
    }
    else{
        xController.setSetpoint(-30);
    }
